# roadmap — full history (archived)

> **Frozen.** This is the pass-by-pass roadmap as it stood through passes 1–17,
> kept for the detail the lean docs drop (the update-check "right first time"
> warnings, pass-14 design debt, the "considered and left out" lists, release
> mechanics). The live plan for what's left is `docs/roadmap.md`; the shipped
> history in brief is `docs/CHANGELOG.md`. Nothing here is updated any more.
